...
#
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04 != X/home/ruiz/geant4/geant4.9.4.p04 ] ; then
    G4INSTALL="/home/ruiz/geant4/geant4.9.4.p04/src/geant4"
else
    G4INSTALL="/home/ruiz/geant4/geant4.9.4.p04"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xn != Xn ] ; then 
    if [ X/home/ruiz/geant4/geant4.9.4.p04 != X/home/ruiz/geant4/geant4.9.4.p04 ] ; then
        G4INCLUDE="/home/ruiz/geant4/geant4.9.4.p04/include/geant4"
    else
        G4INCLUDE="/home/ruiz/geant4/geant4.9.4.p04/include/"
    fi
    export G4INCLUDE
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/lib != X ] ; then 
    if [ X/home/ruiz/geant4/geant4.9.4.p04 != X/home/ruiz/geant4/geant4.9.4.p04 ] ; then
        G4LIB="/home/ruiz/geant4/geant4.9.4.p04/lib/geant4"
    else
        G4LIB="/home/ruiz/geant4/geant4.9.4.p04/lib"
    fi
    export G4LIB
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/PhotonEvaporation2.1 != X ] ; then 
    G4LEVELGAMMADATA="/home/ruiz/geant4/geant4.9.4.p04/data/PhotonEvaporation2.1"
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/RadioactiveDecay3.3 != X ] ; then 
    G4RADIOACTIVEDATA="/home/ruiz/geant4/geant4.9.4.p04/data/RadioactiveDecay3.3"
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/G4EMLOW6.35 != X ] ; then 
    G4LEDATA="/home/ruiz/geant4/geant4.9.4.p04/data/G4EMLOW6.35"
    export G4LEDATA
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/G4NDL3.14 != X ] ; then 
    G4NEUTRONHPDATA="/home/ruiz/geant4/geant4.9.4.p04/data/G4NDL3.14"
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/G4ABLA3.0 != X ] ; then 
    G4ABLADATA="/home/ruiz/geant4/geant4.9.4.p04/data/G4ABLA3.0"
    export G4ABLADATA
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/RealSurface1.0 != X ] ; then 
    G4REALSURFACEDATA="/home/ruiz/geant4/geant4.9.4.p04/data/RealSurface1.0"
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/G4NEUTRONXS1.0 != X ] ; then 
    G4NEUTRONXSDATA="/home/ruiz/geant4/geant4.9.4.p04/data/G4NEUTRONXS1.0"
...
#+
if [ X/home/ruiz/geant4/geant4.9.4.p04/data/G4PII1.2 != X ] ; then 
    G4PIIDATA="/home/ruiz/geant4/geant4.9.4.p04/data/G4PII1.2"
    export G4PIIDATA
    if [ X$g4non_display = X ] ; then
...
# g4clhep.U
#
if [ X/home/ruiz/CLHEP != X ] ; then 
    CLHEP_BASE_DIR="/home/ruiz/CLHEP"
...
#+
if [ X/home/ruiz/CLHEP/include != X ] ; then 
    CLHEP_INCLUDE_DIR="/home/ruiz/CLHEP/include"
...
#+
if [ X/home/ruiz/CLHEP/lib != X ] ; then 
    CLHEP_LIB_DIR="/home/ruiz/CLHEP/lib"
